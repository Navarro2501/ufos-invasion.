...
class AlienInvasion:
	...
	def __init__(self):
		...
		#Instance of Scoreboard to store game Statistics 
	...
	def _create_fleet(self):
		...
		#Make individual alien and find the number of aliens in a row
	...
	def _ship_hit(self):
		...
		if self.stats.ships_left > 0:
			...
			#Create a new float and center the next ship
			self._create_fleet()
			self.ship.center_ship()
